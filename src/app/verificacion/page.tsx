...
import { SearchCheck, FileBadge, ShieldCheck } from 'lucide-react';
                ...
                <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-4">
                                <div className="shrink-0 mt-1 h-10 w-10 bg-white shadow-sm border border-gray-100 rounded-full flex items-center justify-center text-[#8B1E1E]">
                                    1
                                </div>
                                <div>
                    ...
                    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-12 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-500 mb-8">Ingresa el código seguro de 12 a 16 caracteres.</p>
                            ...
                            <form className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="codigo"
                                        name="codigo"
                                        placeholder="Ej. UCP-2025-XXXX-YYYY"
                                ...
                                <button
                                    type="submit"
                                    className="w-full flex items-center justify-center py-4 px-8 border border-transparent rounded-xl shadow-md text-lg font-bold text-white bg-[#8B1E1E] hover:bg-[#731919] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B1E1E] transition-all transform hover:-translate-y-1 gap-3"
                                >
                            ...
                            <div className="mt-8 text-center text-xs text-gray-400 flex items-center justify-center gap-2">
                                ...
                                Validación segura encriptada end-to-end
                            </div>
                        </div>
                    </div>

...
import { crearConvocatoria, getOpcionesConvocatoria } from './convocatorias-actions';
...
export function NuevaConvocatoriaModal({ isOpen, onClose, onSuccess }: Props) {
    ...
    const watchRequiereEntrevista = watch('requiere_entrevista');
    ...
    const onSubmit = async (values: FormData) => {
        ...
        try {
            ...
            toast.success('✅ Convocatoria creada', { 
                id: toastId, 
                description: `'${convocatoria.titulo}' ha sido registrada.` 
            });
    ...
    return (
        <FormModal 
            ...
            subtitle="Publica una nueva convocatoria de servicio social"
        >

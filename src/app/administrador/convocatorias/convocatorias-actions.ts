        ...
        return await db.execute(async (prisma) => {
            ...
            if (data.actividades && data.actividades.length > 0) {
                ...
                return {
                    ...convocatoria,
                    horas_totales_ofrecidas: convocatoria.horas_totales_ofrecidas ? Number(convocatoria.horas_totales_ofrecidas) : null,
                    cupo_maximo: convocatoria.cupo_maximo ? Number(convocatoria.cupo_maximo) : null,
                    cupo_disponible: convocatoria.cupo_disponible ? Number(convocatoria.cupo_disponible) : null,

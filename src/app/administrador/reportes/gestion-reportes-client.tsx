                                ...
                                <div className="bg-orange-50 rounded-lg p-4">
                                    ...
                                    <div className="space-y-2">
                                        {reporteSeleccionado.evidencias.map((evidencia, index) => (
                                            <div key={evidencia.id} className="bg-white rounded-lg p-3 border border-orange-200">
                                                <div className="flex items-center justify-between mb-2">
                                                    <span className="text-xs font-medium text-orange-600">
                                                        #{index + 1} - {evidencia.tipo}
                                                    </span>
                                                    <span className="text-xs text-gray-500">
                                                        {evidencia.nombre_archivo || 'Sin nombre'}
                                                    </span>
                                                </div>
                                                {evidencia.contenido_texto && (
                                                    <p className="text-sm text-[#64748b] bg-gray-50 rounded p-2">
                                                        {evidencia.contenido_texto}
                                                    </p>
                                                )}
                                            </div>

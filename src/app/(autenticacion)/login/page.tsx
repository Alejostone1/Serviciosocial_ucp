...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (result?.error) {
      ...
      const isBlocked = result.error === 'CUENTA_BLOQUEADA' || 
                        result.error.includes('bloqueada');
      
      if (isBlocked) {
        setError('Tu cuenta ha sido bloqueada o desactivada. Por favor, contacta con soporte para más información.');
        toast.error('Cuenta Bloqueada', {
          id: toastId,
          description: 'Tu cuenta ha sido bloqueada o desactivada. Contacta con soporte.',
        });
      } else {
    ...
    const routes: Record<string, string> = {
      ...
      PROFESOR: '/sistema/profesor/dashboard',

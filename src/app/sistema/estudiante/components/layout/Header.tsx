                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="hidden md:flex flex-col items-start leading-[1.1]">
                                <span className="text-sm font-bold text-slate-800 leading-none">Estudiante</span>
                                <span className="text-xs text-slate-500 font-medium mt-0.5">estudiante@ucp.edu.co</span>
                            </div>
                        </button>
                        ...
                        {showUserMenu && (
                            <div className="absolute right-0 mt-3 w-60 bg-white rounded-2xl shadow-xl border border-slate-100 py-2.5 z-50 animate-in fade-in zoom-in-95 duration-200">
                                <div className="px-4 py-3 border-b border-slate-100 mb-2 md:hidden">
                                    <p className="text-sm font-bold text-slate-900 leading-tight">Estudiante</p>
                                    <p className="text-xs text-slate-500 font-medium truncate">estudiante@ucp.edu.co</p>
                                </div>
                                <Link

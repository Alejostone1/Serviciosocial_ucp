...
export function NuevaConvocatoriaModal({ isOpen, onClose, onSuccess }: NuevaConvocatoriaModalProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            setLoading(true);
            await crearConvocatoriaProfesor(formData);
            toast.success('Convocatoria creada exitosamente en modo BORRADOR');
            onSuccess();
            onClose();
            // Reset form
            setFormData({
        ...
        >
            <div className="space-y-10 py-4">
                    ...
                    {step === 1 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500 text-left px-2">
                            <div className="space-y-2">
                                ...
                                <input 
                                    name="titulo" 
                                    placeholder="Ej: Apoyo Académico 2024" 
                ...
                <div className="flex items-center justify-between pt-8 border-t border-slate-100">
                    ...
                    >
                        {loading ? 'Procesando...' : step === 3 ? 'Confirmar y Guardar' : 'Siguiente Paso'}

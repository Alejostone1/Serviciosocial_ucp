...
import { getDashboardStatsProfesor } from '../actions';
...
export default function ProfesorDashboard() {
  ...
  useEffect(() => {
    const loadStats = async () => {
      try {
        const data = await getDashboardStatsProfesor();
        setStats({
          convocatorias: data.convocatorias.total,
          actividades: data.actividades.total,

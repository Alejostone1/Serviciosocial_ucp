...
export default function ProfesorLayout({
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] text-slate-900 overflow-hidden">
      ...
      {/* Sidebar Navigation - Controlled state for mobile */}
      <ProfesorSidebar 
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        {/* Header Navigation - Passing mobile toggle */}
        <ProfesorHeader onMenuToggle={() => setIsMobileMenuOpen(!isMobileMenuOpen)} />
        
        {/* Content Area */}
        <main className="flex-1 overflow-y-auto overflow-x-hidden p-6 lg:px-12 lg:py-10 custom-scrollbar relative z-10 transition-all duration-500">

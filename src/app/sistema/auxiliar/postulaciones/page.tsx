...
import { getPostulacionesAuxiliar, actualizarEstadoPostulacion } from '../actions';
import { toast } from 'sonner';

export default function AuxiliarPostulacionesPage() {
    ...
    const loadData = async () => {
        try {
            setLoading(true);
            const data = await getPostulacionesAuxiliar();
    ...
    const handleAction = async (id: string, newStatus: 'ACEPTADA' | 'RECHAZADA') => {
        try {
            await actualizarEstadoPostulacion(id, newStatus, `Revisado por Auxiliar - ${newStatus}`);
        ...
        <div className="space-y-10 animate-in fade-in duration-700">
            ...
            <div className="px-2">
                ...
                <p className="text-slate-500 text-lg font-normal mt-2 leading-relaxed max-w-2xl">
                    Gestiona las solicitudes de los estudiantes que desean vincularse a proyectos de servicio social.
                </p>
            </div>

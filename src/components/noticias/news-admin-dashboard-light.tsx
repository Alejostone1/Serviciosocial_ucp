                ...
                <div className="p-8 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                        ...
                        <div>
                            <div className="flex flex-col mb-2">
                                <h1 className="text-3xl font-bold text-gray-900 tracking-tight flex items-center gap-3">
                                    <span className="w-1.5 h-8 bg-[#8B1E1E] rounded-full inline-block"></span>
                                    Gestión de Noticias
                                </h1>
                                <p className="text-gray-500 text-lg mt-1 ml-4 italic border-l-2 border-gray-100 pl-4">
                                    Administra el contenido informativo institucional
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                        <motion.div
                            ...
                            className="bg-red-50/30 rounded-2xl p-6 border border-[#8B1E1E]/10 hover:border-[#8B1E1E]/30 transition-all group"
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-[#8B1E1E] text-xs font-bold uppercase tracking-widest mb-1">Total Noticias</p>
                                    <p className="text-3xl font-extrabold text-gray-900">{stats.total}</p>
                                </div>
                                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center border border-[#8B1E1E]/10 group-hover:bg-[#8B1E1E]/5 transition-colors">
                        ...
                        <motion.div
                            ...
                            className="bg-green-50/30 rounded-2xl p-6 border border-green-200 hover:border-green-400 transition-all group"
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-green-600 text-xs font-bold uppercase tracking-widest mb-1">Publicadas</p>
                                    <p className="text-3xl font-extrabold text-gray-900">{stats.published}</p>
                                </div>
                                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center border border-green-100 group-hover:bg-green-50 transition-colors">
                        ...
                        <motion.div
                            ...
                            className="bg-amber-50/30 rounded-2xl p-6 border border-amber-200 hover:border-amber-400 transition-all group"
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-amber-600 text-xs font-bold uppercase tracking-widest mb-1">Borradores</p>
                                    <p className="text-3xl font-extrabold text-gray-900">{stats.draft}</p>
                                </div>
                                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center border border-amber-100 group-hover:bg-amber-50 transition-colors">

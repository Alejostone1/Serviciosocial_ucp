...
export function NewsSection({ initialData }: NewsSectionProps) {
    ...
    const noticias = React.useMemo(() => initialData ?? [], [initialData]);
                            ...
                            <div className="p-8 flex flex-col flex-grow">
                                <div className="flex items-center gap-4 text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-4">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        {noticia.fecha_formateada || new Date(noticia.fecha_publicacion || noticia.creado_en).toLocaleDateString('es-PE', { day: 'numeric', month: 'short', year: 'numeric' })}
                                    </div>

...
import { ChevronLeft, ChevronRight, Clock, Building2, ArrowRight, CheckCircle2, Calendar, MapPin } from 'lucide-react';
        ...
        return (
            ...
            >
                ...
                <div className="relative z-10 container mx-auto text-center">
                    <h2 className="text-3xl font-bold text-slate-900 mb-4">No hay convocatorias disponibles</h2>
                    <p className="text-slate-600">Pronto habrá nuevas oportunidades de servicio social.</p>
                </div>
            </motion.section>
        );
    }

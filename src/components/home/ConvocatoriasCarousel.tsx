...
// Note: useEffect retained for embla-carousel, useState for carousel state
import useEmblaCarousel from 'embla-carousel-react';
import { ChevronLeft, ChevronRight, Clock, Building2, ArrowRight, Calendar, MapPin, Search } from 'lucide-react';
...
export function ConvocatoriasCarousel({ initialData }: ConvocatoriasCarouselProps) {
    ...
    const convocatorias = React.useMemo(() => initialData ?? [], [initialData]);
